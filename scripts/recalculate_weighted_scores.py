...
def main():
    ...
    df = pd.read_csv('src/planner/data/benchmarks/accuracy/opensource_all_benchmarks_interpolated.csv')
    print(f"Loaded {len(df)} models with complete benchmark data")

    # Output directory
    output_dir = 'src/planner/data/benchmarks/accuracy/weighted_scores'
