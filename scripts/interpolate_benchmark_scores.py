...
def main():
    ...
    # Load data
    csv_path = 'src/planner/data/benchmarks/accuracy/opensource_all_benchmarks.csv'
    ...
    output_path = 'src/planner/data/benchmarks/accuracy/opensource_all_benchmarks_interpolated.csv'
