...
from quality_scoring.categories import DEFAULT_CATEGORIES
from quality_scoring.models import CompositeScore, MatchType, ModelScorecard, NormalizedScore
from quality_scoring.resolver import resolve_model_names
from quality_scoring.scoring import (
    ...
    def _build_scorecard(self, resolved: _ResolvedModel) -> ModelScorecard:
        ...
        for cat in self._categories:
            ...
            aa_score: NormalizedScore | None = (
                self._aa_norms.get(cat, {}).get(resolved.aa_name) if resolved.aa_name else None
            )
