...
class TestComputeScorecards:
    def test_basic_scorecard(self):
        ...
        targets: list[tuple[str, str | None, str | None]] = [("Model A", "model-a", "Model A")]
    ...
    def test_arena_only_model(self):
        ...
        targets: list[tuple[str, str | None, str | None]] = [("Model A", "model-a", None)]
    ...
    def test_multiple_categories(self):
        ...
        targets: list[tuple[str, str | None, str | None]] = [("A", "a", "A")]
    ...
    def test_model_not_in_source(self):
        ...
        targets: list[tuple[str, str | None, str | None]] = [("Missing", None, None)]
        result = compute_scorecards(arena_rows, [], targets, ["overall"])
        sc = result[0]
